  ...
  return (
    <section className="main-wrapper pb-5">
      ...
      <div className="content px-4 mt-5">
        <h4 className="fw-bold subTitle">AGREEMENT TO OUR LEGAL TERMS</h4>
        <p className="text">{`We operate , as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").`}</p>
        <p>You can contact us by email at support@stampd.ca.</p>
        <p>
          {` These Legal Terms constitute a legally binding agreement made
                between you, whether personally or on behalf of an entity ("you"),
                and Stampd, concerning your access to and use of the Services.
        ...
        <h4 className="fw-bold subTitle mt-5">OUR SERVICES</h4>
        <p className="text">
        ...
        <h4 className="fw-bold subTitle mt-5">INTELLECTUAL PROPERTY RIGHTS</h4>
        ...
        <ul>
          ...
          <p>
            ...
            please address your request to: support@stampd.ca. If we ever grant
        ...
        <h5 className="fw-bold">Your submissions</h5>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">USER REPRESENTATIONS</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">PROHIBITED ACTIVITIES</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">USER GENERATED CONTRIBUTIONS</h4>
        ...
        <h4 className="fw-bold subTitle mt-5">CONTRIBUTION LICENSE</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">SERVICES MANAGEMENT</h4>
        ...
        <h4 className="fw-bold subTitle mt-5">TERM AND TERMINATION</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">
        ...
        <h4 className="fw-bold subTitle mt-5">GOVERNING LAW</h4>
        <p>
          These Legal Terms shall be governed by and defined following the laws
          of Canada. Stampd and yourself irrevocably consent that the courts of
          Canada shall have exclusive jurisdiction to resolve any dispute which
          may arise in connection with these Legal Terms.
        </p>
        <h4 className="fw-bold subTitle mt-5">DISPUTE RESOLUTION</h4>
        <h5 className="fw-bold">Informal Negotiations</h5>
        <p>
          {`To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.`}
        </p>
        <h5 className="fw-bold">Binding Arbitration</h5>
        <p>
          {`Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 1. The seat, or legal place, or arbitration shall be Canada. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Canada.`}
        </p>
        <h5 className="fw-bold">Restrictions</h5>
        <p>
          {`The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.`}
        </p>
        <h4 className="fw-bold subTitle mt-5">CORRECTIONS</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">DISCLAIMER</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">LIMITATIONS OF LIABILITY</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">INDEMNIFICATION</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">USER DATA</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">MISCELLANEOUS</h4>
        <p>
        ...
        <h4 className="fw-bold subTitle mt-5">CONTACT US</h4>
        <p>
          In order to resolve a complaint regarding the Services or to receive
          further information regarding use of the Services, please contact us
          at:
        </p>
        <p>support@stampd.ca</p>
      </div>
    </section>
  );
}
